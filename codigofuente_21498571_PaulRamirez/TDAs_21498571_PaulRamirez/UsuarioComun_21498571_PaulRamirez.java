...
public class UsuarioComun_21498571_PaulRamirez implements IUsuario_21498571_PaulRamirez {
    ...
    /**
     * Modificador de Usuario comun, cambia el chatHistory al string que se recibe como entrada (lo actualiza)
    ...
    /**
     * equals de usuario comun
     * @param u Objeto a comparar si es igual
     * @return booleano que indica si el objeto recibido es de tipo usuario comun y que ademas tenga el mismo username
     */
    @Override
